            ...
            child: Column(
              ...
              children: [
                ...
                if (_collaborators.isEmpty) ...[
                  ...
                  // Has collaborators - simplified options
                  _buildCollaboratorActionOption(
                    icon: Icons.hourglass_top,
                    title: 'Save & Wait for Responses',
                    subtitle: 'Move to "Pending" tab in Quotes. You\'ll be notified when all collaborators submit.',
                    color: AppColors.warning,
                    onTap: () {
                      _saveAndWaitForCollaborators();
                    },
                  ),
                  const SizedBox(height: 10),
                  _buildCollaboratorActionOption(
                    icon: Icons.skip_next,
                    title: 'Skip & Preview Solo',
                    subtitle: 'Continue without waiting. Send your proposal only, collaborators send independently.',
        ...
        title: Row(
          children: [
            Container(
              ...
              child: Icon(Icons.hourglass_top, color: AppColors.warning, size: 20),
            ),
            const SizedBox(width: 12),
            const Text('Save & Wait'),
          ],
        ),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          ...
          children: [
            const Text(
              'This proposal will be saved to the "Pending" tab in Quotes.',
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('What happens next:', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: AppColors.info)),
                  const SizedBox(height: 8),
                  _buildBulletPoint('Email invitations sent to ${_collaborators.length} collaborator${_collaborators.length > 1 ? 's' : ''}'),
                  _buildBulletPoint('You\'ll be notified when they submit pricing'),
                  _buildBulletPoint('Once all submit, merge & send to client'),
                ],
              ),
            ),
            const SizedBox(height: 12),
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'You can always send without them from the Pending tab.',
                      style: TextStyle(fontSize: 11, color: AppColors.textSecondary),
                    ),
                  ),
                ],
